...
@Injectable()
export class GoogleOAuth2AdminStrategy extends PassportStrategy(Strategy, "google-admin") {
    constructor(private readonly redisService: RedisService) {
        super({
            ...
            callbackURL: env.oauth2[OAuthProvidersEnum.GOOGLE].ADMIN_REDIRECT_URL,
            scope: ["profile", "email"],
            // CSRF
            state: false,
    ...
    async getAuthorizeUrl(preAuthData: { }): Promise<string> {
        ...
        const params = new URLSearchParams({
            ...
            redirect_uri: env.oauth2[OAuthProvidersEnum.GOOGLE].ADMIN_REDIRECT_URL,
            scope: "profile email",
            state: state,
            prompt: "consent",
            access_type: "offline"

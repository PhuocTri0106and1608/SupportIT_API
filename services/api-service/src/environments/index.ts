...
if (!REVIEW_CV_URL || !EXTRACT_CV_URL || !EXTRACT_JD_URL || !EXTRACT_JD_TEXT || !EVALUATE_INTERVIEW_URL) {
    throw new Error("REVIEW_CV_URL || EXTRACT_CV_URL || EXTRACT_JD_URL || EXTRACT_JD_TEXT || EVALUATE_INTERVIEW_URL env is not define");
}

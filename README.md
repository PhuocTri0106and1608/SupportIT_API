...
[Nest](https://github.com/huuduynvc/nestjs-prometheus-grafana-tempo) template that demonstrates a complete observability stack with:
...
- Track request flows through distributed tracing

## Compile and run the project

```bash
# go to the template service
$ cd nestjs-prometheus-grafana-tempo/services/template
